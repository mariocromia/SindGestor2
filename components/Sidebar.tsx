...
export const Sidebar: React.FC<SidebarProps> = ({ user, currentEnterpriseId, onSwitchEnterprise, onLogout }) => {
  ...
  const navItemClass = ({ isActive }: { isActive: boolean }) =>
    `flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
      isActive ? 'bg-blue-600 text-white shadow-md' : 'text-gray-300 hover:bg-slate-800 hover:text-white'
    }`;
